...
var HzDialogResource = HzDialogResource_1 = (function (_super) {
    ...
    HzDialogResource.prototype._assignEvents = function () {
        this._eventEmitter.on(index_1.Navigator.ON_CHANGE_PAGE_START + "." + this._namespace, null, this._onChangePageStart);
    ...
    HzDialogResource.prototype._onChangePageStart = function () {
    ...
    HzDialogResource.prototype.destroy = function () {
        this._eventEmitter.off(index_1.Navigator.ON_CHANGE_PAGE_START + "." + this._namespace);
        this._dialog.close();
